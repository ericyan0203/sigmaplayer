...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/mingw --extra-cflags='-I/mingw/include -L/mingw/lib' --enable-shared --disable-static --enable-gpl --enable-nonfree --enable-postproc --enable-avfilter --enable-runtime-cpudetect --enable-memalign-hack --enable-bzlib --enable-libfaac --enable-libgsm --enable-libmp3lame --disable-libspeex --enable-libtheora --enable-libvorbis --disable-libx264 --disable-libxvid --enable-zlib --disable-debug --enable-pthreads
prefix=/mingw
...
CC_IDENT=gcc 5.3.0 (x86_64-posix-seh-rev0, Built by MinGW-W64 project)
ARCH=x86
CC=gcc
CXX=g++
AS=gcc
...
CFLAGS=  -I/mingw/include -L/mingw/lib -std=c99 -fomit-frame-pointer -pthread -I/mingw/include/SDL -D_GNU_SOURCE=1 -Dmain=SDL_main -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=  -I/mingw/include -L/mingw/lib -fPIC
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
EXTRALIBS=-lavicap32 -lpsapi -lole32 -lstrmiids -luuid -lws2_32 -liconv -L/mingw/lib -lmingw32 -lSDLmain -lSDL -mwindows -lvorbisenc -lvorbis -logg -ltheoraenc -ltheoradec -logg -lmp3lame -lgsm -lfaac -lm -lz -pthread -lpsapi -ladvapi32 -lshell32 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=x64
...
LIBS-ffplay=-L/mingw/lib -lmingw32 -lSDLmain -lSDL -mwindows
LIBS-ffprobe=
LIBS-ffserver=
LIBS-ffmpeg=
!ARCH_AARCH64=yes
