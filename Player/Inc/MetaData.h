...
#ifndef SIGM_META_DATA_H_

#define SIGM_META_DATA_H_
...
enum {
	...
	kKeyDivx3CodecData    = 'dvx3',	 // raw data
    ...
    kKeyStartTime	      = 'staT',  //int64_t (start time)
    ...
    //user defined
    kKeyDisplay           = 'disp',  //int32_t
    kKeyWmaCodecData      = 'wacd',  //raw data
    kKeyWMAVersion        = 'wmav',   //int32_t
    kKeyBlockAllign       = 'baln',   //int32_t
    kKeyPcktSize          = 'pksz',   //int32_t
    kKeyNumPackets        = 'npkt',   //int32_t
    kKeyValidbps          = 'vbps',   //int32_t
    kKeyChnlMask          = 'cnmk',   //int32_t
    kKeyAdvEncOp2         = 'aeo2',   //int32_t
    kKeyEncOpt            = 'enop',   //int32_t
    kKeyAdvEncOp          = 'adeo',   //int32_t
    kKeyFmtTag            = 'fmtt',   //int32_t
    kKeyflavor            = 'flav',   //int32_t
