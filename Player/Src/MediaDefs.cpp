...
const char *MEDIA_MIMETYPE_AUDIO_WMA1 = "audio/wma1";
const char *MEDIA_MIMETYPE_AUDIO_WMA2 = "audio/wma2";
const char *MEDIA_MIMETYPE_AUDIO_WMA3 = "audio/wma3";
...
const char *MEDIA_MIMETYPE_AUDIO_RA = "audio/x-pn-realaudio";

const char *MEDIA_MIMETYPE_VIDEO_VP6 = "video/x-vp6";
const char *MEDIA_MIMETYPE_VIDEO_VP8 = "video/x-vp8";
const char *MEDIA_MIMETYPE_VIDEO_VP8X = "video/x-vnd.on2.vp8";
const char *MEDIA_MIMETYPE_VIDEO_VP9 = "video/x-vnd.on2.vp9";

const char *MEDIA_MIMETYPE_AUDIO_DTS = "audio/dts";

const char *MEDIA_MIMETYPE_CONTAINER_TS = "application/octet-stream";
